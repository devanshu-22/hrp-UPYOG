    ...
    <div className="employee">
      <Switch>
        <Route path={`${path}/user`}>
          ...
          >
            <div className="loginnn">
              ...
              <picture>
                <source id="backgroung-login" media="(min-width: 950px)" srcset="https://assets-hrdulb.sparrowsoftech.in/hr-dulb-asset/haryanabanner.png" style={{"position":"absolute","height":"100%","width":"100%"}} />
                  <source media="(min-width: 250px)" srcset="https://assets-hrdulb.sparrowsoftech.in/hr-dulb-asset/SBMlogo.png" />
                    <img src="https://assets-hrdulb.sparrowsoftech.in/hr-dulb-asset/haryanabanner.png" alt="imagealttext" style={{"position":"absolute","height":"100%","width":"100%","zIndex":"1","display":window.location.href.includes("user/profile")?"none":""}}/>
                    </picture>
          ...
          <div className={`main ${DSO ? "m-auto" : ""}`}>
            ...
            {/* <div className="footerr" style={{ width: '100%', bottom: 0,backgroundColor:"white",color:"black !important"}}>
              <div style={{ display: 'flex', justifyContent: 'center', color:"color","backgroundColor":"#808080b3"  }}>
                ...
                <span style={{ cursor: "pointer", fontSize: "16px", fontWeight: "400"}} onClick={() => { window.open('https://sparrowsoftech.com/sspl/', '_blank').focus();}} >Designed & Developed By Sparrow Softech Pvt. Ltd  </span>
                <span style={{ margin: "0 10px" }}>|</span>
                <a style={{ cursor: "pointer", fontSize: "16px", fontWeight: "400"}} href={pdfUrl} target='_blank'></a>
              </div>
            </div> */}
        ...
        <div style={{ display: 'flex', justifyContent: 'center', color:"black" }}>
          ...
          <a style={{ cursor: "pointer", fontSize: window.Digit.Utils.browser.isMobile()?"12px":"14px", fontWeight: "400"}} href="https://pg-egov-assets.s3.ap-south-1.amazonaws.com/Upyog+Code+and+Copyright+License_v1.pdf" target='_blank'>UPYOG License</a>

          <span  className="upyog-copyright-footer" style={{ margin: "0 10px",fontSize: window.Digit.Utils.browser.isMobile()?"12px":"14px" }} >|</span>
          <span  className="upyog-copyright-footer" style={{ cursor: "pointer", fontSize: window.Digit.Utils.browser.isMobile()?"12px":"14px", fontWeight: "400"}} onClick={() => { window.open('https://ulbharyana.gov.in/', '_blank').focus();}} >Copyright © 2025 Municipal Corporation of Haryana</span>
          <span  className="upyog-copyright-footer" style={{ margin: "0 10px",fontSize: window.Digit.Utils.browser.isMobile()?"12px":"14px" }} >|</span>
          <span  className="upyog-copyright-footer" style={{ cursor: "pointer", fontSize: window.Digit.Utils.browser.isMobile() ? "12px" : "14px", fontWeight: "400" }}
            onClick={() => {
              window.open("https://sparrowsoftech.com/sspl/", "_blank").focus();
            }}
          >
        ...
        <div className="upyog-copyright-footer-web">
          <span className="" style={{ cursor: "pointer", fontSize:  window.Digit.Utils.browser.isMobile()?"12px":"14px", fontWeight: "400"}} onClick={() => { window.open('https://ulbharyana.gov.in/', '_blank').focus();}} >Copyright © 2025 Municipal Corporation of Haryana</span>
          </div>
      </div>
          </div>
        </Route>
